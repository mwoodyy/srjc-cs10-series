...
namespace cs_set {
    ...
    class ArraySet : public SetInterface<ItemType>
    {
        public:        
            ...
            ArraySet();
            ArraySet(ArraySet<ItemType>& copy);
            ArraySet(int size);
            ~ArraySet();
            int size() const;
            bool empty() const;
            ...
            ArraySet<ItemType> setUnion(ArraySet<ItemType>& right); 
            ArraySet<ItemType> setIntersection(ArraySet<ItemType>& right);
            ArraySet<ItemType> setDifference(ArraySet<ItemType>& right);
        private:
